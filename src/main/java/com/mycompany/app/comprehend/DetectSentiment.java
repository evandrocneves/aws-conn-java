...
*/
package com.mycompany.app.comprehend;
...
//        String text = "Amazon.com, Inc. is located in Seattle, WA and was founded July 5th, 1994 by Jeff Bezos, allowing customers to buy everything from books to blenders. Seattle is north of Portland and south of Vancouver, BC. Other notable Seattle - based companies are Starbucks and Boeing.";
    ...
    try {
        ...
        StringBuilder builder = new StringBuilder("The Neutral value is " + detectSentimentResult.sentimentScore().neutral());
        builder.append("\nThe Positive value is " + detectSentimentResult.sentimentScore().positive())
                .append("\nThe Negative value is " + detectSentimentResult.sentimentScore().negative());
