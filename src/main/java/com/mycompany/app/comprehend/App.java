...
//
//        Region regionBuilder = Region.of(region);
//
//
//        s3 = S3Client.builder().
//                credentialsProvider(new AwsCredentialsProvider().resolveCredentials())
...
//
//                s3.createBucket(new CreateBucketRequest(S3ClientBuilder(bucket_name, region)));
//            } catch (S3Exception e) {
...
//        List<ListBucketsResponse> buckets = s3.listBuckets();
//
